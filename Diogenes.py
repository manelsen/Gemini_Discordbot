...
async def generate_global_summary():
    ...
    Esse resumo deve incluir nome, raça, classe, ingrediente favorito e uma informação relavante sobre cada usuário, sem exceção de nenhum. Organize por bullets.
    """
